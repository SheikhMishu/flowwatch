  ...
  return (
    <section className="py-28 bg-[#f1f5f9] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <AnimateOnScroll animation="fade-in" className="text-center mb-20">
        ...
        <div className="hidden md:block relative">
          ...
          <motion.div
            className="absolute top-[2.1rem] left-[4.5rem] right-[4.5rem] h-px bg-gradient-to-r from-red-400/30 via-violet-400/40 to-emerald-400/30"
            initial={{ scaleX: 0 }}
