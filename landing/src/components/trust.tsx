    ...
    <section className="py-28 bg-[#0d0d14]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <p className="text-xs font-bold uppercase tracking-widest text-indigo-400 mb-5">Built for real n8n users</p>
          <h2 className="font-display font-bold text-4xl sm:text-5xl text-white mb-6">
            What you can expect.
          </h2>

          {/* Trust checklist */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl mx-auto text-left mt-10">
            {trustPoints.map((pt) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {expectations.map((item) => {
            ...
            return (
              <div key={item.title} className="glass-card rounded-2xl p-6 hover:border-white/10 transition-all duration-300">
                ...
                <p className="text-zinc-200 text-sm font-semibold mb-2">{item.title}</p>
